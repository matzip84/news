<?php
/**
* PrimeWP_Customize_Recommended_Plugins class
*
...
class PrimeWP_Customize_Recommended_Plugins extends WP_Customize_Control {
    ...
    public function render_content() {
        ...
        'wp-pagenavi' => array( 
            ...
            'text'  => esc_html__( 'WP-PageNavi', 'primewp' ),
            'desc'  => esc_html__( 'WP-PageNavi plugin helps to display numbered page navigation of this theme. Just install and activate the plugin.', 'primewp' ),
            ),
        'regenerate-thumbnails' => array( 
            'link'  => esc_url( admin_url('plugin-install.php?tab=plugin-information&plugin=regenerate-thumbnails' ) ),
            'text'  => esc_html__( 'Regenerate Thumbnails', 'primewp' ),
            'desc'  => esc_html__( 'Regenerate Thumbnails plugin helps you to regenerate your thumbnails to match with this theme. Install and activate the plugin. From the left hand navigation menu, click Tools &gt; Regen. Thumbnails. On the next screen, click Regenerate All Thumbnails.', 'primewp' ),
            ),
        );
